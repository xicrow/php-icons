...
abstract class BaseIcon
{
     ...
     * @return static
     */
    public static function Icon(string $strIdentifier, ...$arrModifiers): self
    {
     ...
     * @param string[] $arrModifiers
     */
    public function __construct(string $strIdentifier, ...$arrModifiers)
    {
     ...
     * @return static
     */
    public function modify(...$arrModifiers): self
    {
